...
In the Fall of 2016 you cut down some trees that impeded your view
of a beautiful valley outside the back window of your house.
Fences are uncommom in your semi-rural area
and it turns out you cut down your neighbor's trees,
not your own!
It took some time,
but in the Spring of 2017 your neighbor discovered the error
and filed a lawsuit against you for 
hundreds of thousands of dollars in lost property value
and other damages to be determined later. 
Thank goodness for homeowners insurance!
You filed a claim with your insurance carrier 
who took away all your worries about hiring a lawyer,
defending your case,
and paying whatever damages are ultimately decided.

Well, almost all your worries ... you start to wonder ...
"Will my carrier be around to defend me
and basically see this
through to the very end,
whatever that may be?"
For your sake, Gentle Reader, 
I certainly hope so.

It is in every policyholder's interest 
that their insurance company will stay in business
long enough to pay all benefits owed its policyholders.
...
For example,
as of 12/31/2016 your insurance company did not know
that your claim had yet to be filed,
but you paid your 2016 premium so they must have sufficient funds
as of 12/31/2016 to 
...
text(x=1.5, y=3,"Case Incurred = case Paid + Case Reserves", pos = 4)
brackets(1.5, 10, 1.5, 5, ticks = .4, curvature = .2, type = 2,
         col = 1, lwd = 1, lty = 1)
text(x=2, y=8,"Total Reserves = Case Reserves + IBNR", pos = 4)
